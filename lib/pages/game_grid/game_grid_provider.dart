...
class GameGridProvider extends BaseProvider<GameGridState> {
  int get gridSize => gameController.gridSize;
  ...
  GameGridProvider(this.context)
    : super(
        GameGridState(
          playerTurn: gameController.playerTurnStream.value,
        ),
      ) {
    _setListeners();
  }
  ...
  void _gameStatusListener(GameStatus gameStatus) {
    state.playable = gameStatus == GameStatus.none || gameStatus == GameStatus.playing;
